...
import { InjectQueryService, mergeFilter, QueryService, UpdateManyResponse } from '@m8a/nestjs-query-core'
import { HookInterceptor, HookTypes, MutationHookArgs, UpdateManyResponseType } from '@m8a/nestjs-query-graphql'
