...
`@m8a/nestjs-query-graphql` provides a number of types. Most will be automatically generated for you when you create a
...
```ts
import { DeleteManyResponseType } from '@m8a/nestjs-query-graphql';
...
GraphQL implementation of the `@m8a/nestjs-query-core` `Filter` type.
...
```ts
import { FilterType } from '@m8a/nestjs-query-graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { UpdateOneInputType } from '@m8a/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { CreateOneInputType, FilterType } from '@m8a/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
...
```ts
import { DeleteOneInputType } from '@m8a/nestjs-query-graphql';
import { InputType } from '@nestjs/graphql';
import { TodoItemDTO } from './dto/todo-item.dto';
