...
The core of `nestjs-query` is the `Query`, it is used by `@m8a/nestjs-query-graphql`, `@m8a/nestjs-query-typeorm`
`@m8a/nestjs-query-sequelize`, `@m8a/nestjs-query-mongoose` and `@m8a/nestjs-query-typegoose`.
