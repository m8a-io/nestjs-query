...
[![npm version](https://img.shields.io/npm/v/@m8a/nestjs-query-graphql.svg)](https://www.npmjs.org/package/@m8a/nestjs-query-graphql)
...
The get started with the `@m8a/nestjs-query-graphql` package checkout
