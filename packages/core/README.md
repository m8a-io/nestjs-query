...
[![npm version](https://img.shields.io/npm/v/@m8a/nestjs-query-core.svg)](https://www.npmjs.org/package/@m8a/nestjs-query-core)
...
# `@m8a/nestjs-query-core`

Core package that contains interfaces for types used by [`@m8a/nestjs-query-graphql`](../query-graphql)
and [`@m8a/nestjs-query-typeorm`](../query-typeorm)
