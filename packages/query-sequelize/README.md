...
[![npm version](https://img.shields.io/npm/v/@m8a/nestjs-query-sequelize.svg)](https://www.npmjs.org/package/@m8a/nestjs-query-sequelize)
...
# `@m8a/nestjs-query-sequelize`

The `query-sequelize` package that provides an implementation of `@m8a/nestjs-query-core` `QueryService`, built on
...
The get started with the `@m8a/nestjs-query-sequelize` package checkout
