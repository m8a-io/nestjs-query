...
[![npm version](https://img.shields.io/npm/v/@m8a/nestjs-query-typeorm.svg)](https://www.npmjs.org/package/@m8a/nestjs-query-typeorm)
...
# `@m8a/nestjs-query-typeorm`

The `query-typegoose` package that provides an implementation of `@m8a/nestjs-query-core` `QueryService`, built on
